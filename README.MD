...
![Pong Demo](demo/pong_raylib_demo.png)
...
Pre-built executables for Windows and Linux are available here:

**[Download the latest release](https://github.com/Claudiu-Meiu/Pong/releases/latest)**
